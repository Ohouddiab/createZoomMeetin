...
type zoom_detailsInterface = Document & {
  agenda: string;
  default_password: boolean;
  duration: number;
  password: string;
...
interface zoom_detailsDoc extends mongoose.Model<zoom_details> {
  agenda: zoom_detailsInterface["agenda"];
  default_password: zoom_detailsInterface["default_password"];
  duration: zoom_detailsInterface["duration"];
  password: zoom_detailsInterface["password"];
  pre_schedule: zoom_detailsInterface["pre_schedule"];
  recurrence: zoom_detailsInterface["recurrence"];
  schedule_for: zoom_detailsInterface["schedule_for"];
  settings: zoom_detailsInterface["settings"];
  start_time: zoom_detailsInterface["start_time"];
  template_id: zoom_detailsInterface["template_id"];
  timezone: zoom_detailsInterface["timezone"];
  topic: zoom_detailsInterface["topic"];
  tracking_fields: zoom_detailsInterface["tracking_fields"];
  type: zoom_detailsInterface["type"];
}
...
const zoom_detailsSchema = new Schema(
  {
