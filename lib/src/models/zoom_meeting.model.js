...
exports.zoomMeetingPostSchema = void 0;
...
const zoom_meetingSchema = new mongoose_1.Schema({
    agenda: {
        type: String,
        maxlength: 2000,
...
const zoomMeetingPostSchema = mongoose_1.default.model("zoom_meetings", zoom_meetingSchema);
exports.zoomMeetingPostSchema = zoomMeetingPostSchema;
